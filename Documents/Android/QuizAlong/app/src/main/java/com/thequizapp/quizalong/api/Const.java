...
public final class Const {
    ...
    public static final String APP_PAST_LEADERBOARD = "leaderboard/getPastLeaderboard/{quiz_id}/{user_id}";
    public static final String APP_LIVE_LEADERBOARD = "leaderboard/getLiveLeaderboard/{quiz_id}";
